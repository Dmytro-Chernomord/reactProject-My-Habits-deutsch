      ...
      {showSubscriptions ? (
        ...
        <>
          {showAvatars ? (
            ...
            <>
              <Header title="Persönlicher Bereich"></Header>
              <div className={styles.containerProfile}>
                <h2 className={styles.titleProfile}>Persönliche Daten</h2>
                  ...
                  <div className={styles.boxAvatar}>
                    ...
                    >
                      <div className={styles.buttonDiv}>
                        <Button variety={'white'} text="Subscription ändern" />
                      </div>
                    </NavLink>
                  </div>
                </div>
