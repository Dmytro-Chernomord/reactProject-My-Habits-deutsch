          ...
          <div className={style.subscribe}>
            {showInfo && (
              <div className={style.Info}>
                Wir schenken dir unsere beste Subscription für 7 Tagen! -Willst
                du nicht ? - click auf "Stop", oder wähle eine andere! Viel
                Spass!
              </div>
            )}
            <button
            ...
            <p className={style.color}> 30 Tagen — $4.99</p>
          </div>
          <div className={style.subscribe}>
            <button
              type="button"
            ...
            <p className={style.color}>
              1 Monat — $4.80 <span className={style.span}>- 3%</span>
            </p>
          </div>
          <div className={style.subscribe}>
            <button
            ...
            <p className={style.color}>
              3 Monaten — $14.20 <span className={style.span}>- 5%</span>
            </p>
          </div>
          <div className={style.subscribe}>
            <button
            ...
            <p className={style.color}>
              6 Monaten — $27.84 <span className={style.span}>- 7%</span>
            </p>
          </div>
          <div className={style.subscribe}>
            <button
            ...
            <p className={style.color}>
              12 Monaten — $53.89 <span className={style.span}>- 10%</span>
            </p>
          </div>
        </div>
